...
function calculateInterest() {
  let inputBalanceNodes=document.getElementsByClassName('bank-balance')
  let displayBalances=document.getElementsByClassName('update-balance')
  let temp
